                ...
                <div className="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div>
                      ...
                      <h6 className="fw-semibold">{data?.totalIndividuals}</h6>
                    </div>
                  </div>
                  <div
                    id="new-user-chart"
                ...
                <div className="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div>
                      ...
                      <h6 className="fw-semibold">{data?.totalCompanies}</h6>
                    </div>
                  </div>
                  <div
                ...
                <div className="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div>
                      ...
                      <h6 className="fw-semibold">{data?.totalInspections}</h6>
                    </div>
                  </div>
                  <div
                  ...
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <div>
                      ...
                      <h6 className="fw-semibold">
                        {data?.totalAdsIncome?.totalIncome}
                      </h6>
                    </div>
                  </div>
                  <div
