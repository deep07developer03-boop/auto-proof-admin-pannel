  ...
  return (
    <section className={mobileMenu ? "overlay active" : "overlay "}>
      ...
      >
        ...
        <div className="text-center m-0-auto">
          <Link to="/" className="sidebar-logo">
            {/* <h6>Admin Pannel</h6> */}
            {/* <img
              src="assets/images/auto-proof_logo.png.png"
              alt="site logo"
        ...
        <div className="sidebar-menu-area">
          <ul className="sidebar-menu" id="sidebar-menu">
            ...
            <li className="dropdown">
              <Link to="#">
                <FaUsersRectangle className="menu-icon" />
                <span>All users</span>
              </Link>
            ...
            <li className="dropdown">
              <Link to="#">
                <FcInspection className="menu-icon" />

                <span>All Inspection</span>
              </Link>
              <ul className="sidebar-submenu">
                <li>
                  <NavLink
